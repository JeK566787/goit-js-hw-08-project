...
const fillContactFormElements = ()=>{
    ...
    for(const prop in userDataFromLS)//   только по собственным свойствам
    if (userDataFromLS.hasOwnProperty(prop)) // записуем данные с объекта в форму
...
// слушатили событий
formRef.addEventListener("input", (0, _lodashThrottleDefault.default)(onContactFormInput, 500));
